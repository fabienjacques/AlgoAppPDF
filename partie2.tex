...
\fbox{\begin{minipage}{\textwidth}
    \centerline{\textbf{Force Brute : Collisions entre les robots}}\vspace{\baselineskip}
...
\newpage
\subsection{Positions initiales des défenseurs}
...
\fbox{\begin{minipage}{\textwidth}
    \centerline{\textbf{Méthode Gloutonne : Collisions entre les robots}}\vspace{\baselineskip}
