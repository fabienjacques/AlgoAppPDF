...
\fbox{\begin{minipage}{0.9\textwidth}
    ...
    \textbf{Entrées : }$G = (V = V_t \cup V_p, E)$
    
    \textbf{Sortie : }Un ensemble $D \in V_t$ de taille minimale qui domine $V_t$ ou FAUX si un tel ensemble de taille inférieure à 7 n'existe pas. \vspace{\baselineskip}
