...
\fbox{\begin{minipage}{\textwidth}
    ...
    Où $\phi(i, g, j)$ représente $B{g, j}$ si le $j$-ième bit de la représentation en binaire de l'entier $i$ avec $log_2(|V_p|)$ chiffres est un $1$ et $\neg B{g, j}$ sinon.
    
\end{minipage}}

\vspace{2\baselineskip}

La formule $\phi_1$ est de taille constante car elle contient dans le pire des cas $|V_p| ^{|V_t| \cdot K_{max}}$ littéraux. EXPLIQUER \newline
